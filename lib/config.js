...
module.exports = {
   ...
   */
  conjunctions: new Set(['to', 'be', 'been', 'is', 'that', 'which', 'and', 'has', 'have', 'with', 'at', 'same', 'in', 'a', 'an', 'the']),

  /*!
   * Set of type names that are allowed.
   * See section 3.5 of <http://json-schema.org/latest/json-schema-core.html>
   */
  whitelistedTypes: new Set(['array', 'boolean', 'integer', 'number', 'null', 'object', 'string'])
