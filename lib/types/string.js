...
Chainable.keyword(Schematik.String, 'min');
Chainable.keyword(Schematik.String, 'max');
...
Chainable.register(Schematik.String, 'length', function (a, b) {
  self = this.self();
...
Chainable.register(Schematik.String, 'matches', function (pattern) {
  self = this.self();
...
Chainable.register(Schematik.String, 'oneOf', function () {
  self = this.self();
