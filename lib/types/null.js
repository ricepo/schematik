...
var SkNull = (function (_Schematik) {
  _inherits(SkNull, _Schematik);

  function SkNull() {
    _classCallCheck(this, SkNull);

    _get(Object.getPrototypeOf(SkNull.prototype), 'constructor', this).call(this);
    this.__type('null');
  }
...
exports['default'] = function (schematik) {
  ...
  schematik['null'] = schematik.prototype['null'] = function () {
    return (0, _utilInstantiate2['default'])(this.self(), schematik.Null);
  };
};
//# sourceMappingURL=../types/null.js.map